...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "SESSION HERE",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*👀 SEEN YOUR STATUS BY NERAX BOT 🤍*",
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/i4blgt.jpg",
// add custom menu and mention reply image url
PREFIX: process.env.PREFIX || ".",
// add your prefix for bot   
BOT_NAME: process.env.BOT_NAME || "NERAX BOT",
// add bot name here for menu
STICKER_NAME: process.env.STICKER_NAME || "NERAX",
