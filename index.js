...
const {
  AntiDelDB, initializeAntiDeleteSettings, setAnti, getAnti,
  getAllAntiDeleteSettings, saveContact, loadMessage,
  getName, getChatSummary, saveGroupMetadata, getGroupMetadata,
...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
  if (!config.SESSION_ID) return console.log('⚠️ Please add your SESSION_ID in ENV !!')
...
├─ ⚡ Status: *Ultra Fast & Powerful*  
├─ 🌍 Mode: *Smart WhatsApp AI Bot*  
│
╰─ 🍁 Ready to Serve You Master! 🍁

🖤 Thank you for choosing *NERAX-BOT* 🚀
...
`)
      ...
      //==== Fancy Connection Message ====//
      let up = `╭─〔 *🤖 NERAX-BOT* 〕  
├─▸ *Ultra Super Fast Powerfull ⚡*  
│     *World Best BOT NERAX-BOT* 
...
├─ 🌟 *Star the Repo:*  
│    https://github.com/mrpopkid/NERAX-BOT  
╰─🚀 *POWERED BY POPKID*`;

      conn.sendMessage(conn.user.id, {
        image: { url: `https://files.catbox.moe/i4blgt.jpg` },
        caption: up
      })
    }
  })
  ...
  //================= REMAINING HANDLERS =================//
  // (I didn’t change them – only the styling above ✨)
//==============================
